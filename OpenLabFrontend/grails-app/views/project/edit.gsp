...
<div id="edit-project" class="content scaffold-edit" role="main">
    ...
    <g:form name="editprojectInstanceForm" method="post">
        ...
        <fieldset class="buttons">
            <g:submitToRemote update="body" class="save" action="update"
                              value="${message(code: 'default.button.update.label', default: 'Update')}"/>
            <g:submitToRemote update="body" class="delete" action="delete"
