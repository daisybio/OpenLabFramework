<div id="modalBox" style="height: 300px; overflow:scroll;">
    <g:form method="post">
        ...
        <div class="buttons">
            <span class="button"><g:submitToRemote onSuccess="Modalbox.hide();"
                                                   update="[success: 'body', failure: 'body']" class="save"
                                                   action="changeProperty"
                                                   value="${message(code: 'default.button.update.label', default: 'Update')}"/>
            <g:submitToRemote class="create" controller="${controllerName}" onSuccess="Modalbox.hide();" action="create"
                              update="[success: 'body', failure: 'error']"
                              value="${message(code: 'default.button.list.label', default: 'Create')}"/>
            </span>
        </div>
    </g:form>
</div>